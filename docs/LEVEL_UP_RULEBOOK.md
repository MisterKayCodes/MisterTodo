...
This rulebook is **mandatory** for all development, testing, and deployment phases of Mister_Todo.
...
1. **Backup:** Back up production data first.
2. **Staging:** Test updates locally or in a dev environment, including running all tests.
3. **Graceful Stop:** Stop the service safely on your server.
4. **Atomic Update:** Pull code and update dependencies.
5. **Monitor:** Restart and watch logs and metrics immediately for anomalies.
6. **Rollback Plan:** Be ready to revert to the previous version instantly if things fail.
...
Following these rules turns code into a resilient, maintainable system.

---

*This document is part of the Mister_Todo project and must be followed by everyone involved.*
